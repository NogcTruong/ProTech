...
import SelectVersionModal from "@/components/product/SelectVersionModal";
...
export default function DetailProductPage() {
  ...
  return (
    <main className="product-detail-page mb-10">
      <div className={`${responsiveWidth ? "py-2" : "py-4"}`}>
        <div
          className={`${
            responsiveWidth ? "px-4 max-md:mb-2" : "container mb-4"
          }`}
        >
          <nav className="min-w-0 relative">
        ...
        {!responsiveWidth ? (
                  ...
                  <div className="flex flex-col space-y-4 md:space-y-6">
                    <div className="flex flex-col space-y-2">
                      ...
                      <h1 className="text-2xl font-bold">
                        Ghế Công Thái Học Herman Miller Aeron (Size B - Chân
                        nhựa - Graphite - Mới, Full box, Nhập khẩu)
                      </h1>
                  ...
                  <div className="flex-1 flex flex-col space-y-1">
                    ...
                    <div>
                      <p className="text-sm line-clamp-4">
                        Thành lập từ năm 1927 tại Mỹ, Herman Miller được biết
                        như một trong những nhà sản xuất nội thất hàng đầu tại
                        Mỹ. Sản phẩm của Herman Miller rất đa dạng với sản phẩm
                        ghế công thái học vô cùng cao cấp được rất nhiều người
                        trên thế giới tin dùng với khả năng
                      </p>
                    </div>
                    <div>
                      <Link
                ...
                <div className="mt-4 md:mt-6 section-detailed-article__wrapper">
                  <div className="editor-viewer prose prose-sm md:prose-base">
                    <h2 className="font-bold font-lexend">
                      Ghế công thái học Herman Miller Aeron: Thiết kế thông
                      minh, tính chuyên nghiệp cao
                    </h2>
          ...
          <div className="mt-1 flex flex-col space-y-5 px-4">
              ...
              <div className="relative">
                <div className="relative w-full flex overflow-x-auto snap-x snap-mandatory scroll-smooth bg-white border rounded-2xl no-scrollbar">
                  {reviews.map((rev, ridx) => (
                    <div
                      key={ridx}
                      className="flex flex-none snap-center basis-full aspect-w-1 aspect-h-1 md:aspect-w-16 md:aspect-h-9"
                    >
                      <Image
                        width={400}
                        height={400}
            ...
            <section className="scroll-mt-20">
              <div className="flex flex-col space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col">
                  ...
                  <SelectVersionModal
                    open={isSelectVersion}
                    onClose={() => setIsSelectVersion(false)}
            ...
            <div className="rounded-2xl bg-gray-50 border overflow-hidden p-4">
              <div className="flex space-x-6">
                <div className="shrink-0 flex items-center space-x-[6px]">
                  <div className="w-6 h-6 flex items-center justify-center rounded-full bg-blue-500">
                    <svg
            ...
            <div className="rounded-2xl bg-gray-50 border overflow-hidden p-4">
              <div className="grid grid-cols-1 max-md:divide-y max-md:divide-space-y-3 md:divide-x md:divide-space-x-2 md:grid-cols-2">
                <div className="flex flex-row md:flex-col md:items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <div className="flex-1 flex flex-col space-y-1">
                ...
                <div>
                  <p className="text-sm line-clamp-4">
                    ...
                    thái học vô cùng cao cấp được rất nhiều người trên thế giới
                    tin dùng với khả năng
                  </p>
                </div>
                <div>
                  <Link
            ...
            <div
              className="section-detailed-article relative md:p-6 md:border md:rounded-2xl md:shadow-md scroll-mt-20"
              ref={postRef}
            >
              <h3 className="text-xl md:text-3xl font-bold font-lexend">
                Bài viết chi tiết
              ...
              <div className="mt-4 md:mt-6 section-detailed-article__wrapper">
                <div className="editor-viewer prose prose-sm md:prose-base">
                  <h2 className="font-bold font-lexend text-xl">
