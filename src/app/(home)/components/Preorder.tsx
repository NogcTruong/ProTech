...
import mascotPreorder from "@/assets/logos/mascot-preorder.png";
...
export default function Preorder() {
  ...
  useEffect(() => {
    if (containerRef.current) {
      ...
      const handleScroll = () => {
        ...
        const scrollClient = container.clientWidth;

        const maxScroll = scrollWidth - scrollClient;
  ...
  return (
    <section className="section-pre-order mt-10 md:mt-20">
      <div className="flex md:justify-center items-start space-x-2 md:space-x-6">
        <Image
          width={56}
          height={56}
          src={mascotPreorder}
        ...
        <div className="relative group/scrollable">
                ...
                {Products && Products.length > 0 ? (
                  Products.map((product, index) => (
                    <Link
                      ...
                      className="t-product-card group relative border rounded-2xl transition-all bg-white w-[200px] md:w-[250px] shrink-0"
                    >
                      <div className="h-full flex flex-col space-y-2 md:space-y-3">
                        <div className="preorder-aspect-w-1 preorder-aspect-h-1 rounded-2xl overflow-hidden bg-white">
          ...
          {scrollWidthFull > 1200 && (
            <div className="h-10 hidden md:flex flex-col justify-end">
              <div className="bg-white/20 w-full relative h-[2px]">
                <div
