      ...
      <div className="relative z-50">
        <div className="fixed inset-0 overflow-y-hidden z-10">
          <div className="flex min-h-full items-end sm:items-center justify-center text-center max-md:h-full">
            <div className="relative text-left rtl:text-right flex flex-col bg-white shadow-xl h-full">
                  ...
                  <div className="flex items-start space-x-5">
                    ...
                    <div className="flex-1 flex flex-col space-y-2">
                      <span className="text-base font-lexend font-bold">
                        Bàn phím cơ PMO Wave75 Aluminum CNC (Sliver Mirror Glass
                        Weight (Tạ Gương) - RGB - Black - Mới, Full box, Nhập
                        khẩu)
                      </span>
                      <span className="text-sm text-gray-600">
                        Sliver Mirror Glass Weight (Tạ Gương) - RGB / Black /
      ...
      <div className="flex-1 p-4 flex flex-col overflow-auto w-[600px]">
        ...
        <div className="mt-4">
          ...
          <div className="mt-3 flex items-center space-x-4">
                ...
                <div className="w-[80px] h-[80px] border rounded-lg overflow-hidden">
                  <div className="absolute top-1 right-1 z-10">
                    <button
                      type="button"
                      onClick={() => removeImage(index)}
                      className="focus:outline-none focus-visible:outline-0 disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:cursor-not-allowed aria-disabled:opacity-75 flex-shrink-0 font-bold font-lexend rounded-full text-xs gap-x-1 p-1 shadow-sm ring-1 ring-inset ring-gray-300 text-gray-900 bg-white hover:bg-gray-50 disabled:bg-white aria-disabled:bg-white focus-visible:ring-2 focus-visible:ring-colorPrimary500 inline-flex items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
            ...
            {selectedImages.length < 3 && (
              <label htmlFor="t-upload-desktop">
                <div className="w-[80px] h-[80px] border rounded-lg flex items-center justify-center cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
